...
import { Globe, Loader2, Save, Palette, Type, Fingerprint, Sparkles, CheckCircle, Upload, Image as ImageIcon, Trash2, AlertTriangle } from 'lucide-react';
          ...
          {dna?.logoImage && (
             <div>
                ...
                <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-4 flex justify-center">
                    <img src={dna.logoImage} className="max-h-24 object-contain" alt="Brand Logo" />
                </div>
             </div>
          )}
